...
#while not valid_username(Username):
    ...
    # This code is goin to give error because the get_username is not defined
...
#(x = 1 # This code is not executing in VS Code while was working 
#sum = 0
#while x < 10:
  #  sum = sum + x
   # x = x + 1
...
#product = 1
#x = 1 (correctd the error)Added x initialiazation to start again from x
#while x < 10:
 #   product = product * x
  #  x = x + 1

#print(sum, product)
#Ouput 45 1 if we forget to initializa the x variable)
...
# if x != 0: (if x is 0 it will not start the loop )
   # while x % 2 == 0: (it will keep on goin if x is 0 sp need to define)
       # x = x / 2 (or can be defined this way)
 # while x != 0 and x % 2 == 0:
#  x = x / 2    
